...
public class FacsVersion_ZeroMQFACSvatar : MonoBehaviour
{
    ...
    public FacsVersion_FACSnimator FACSModel0;
	  public FacsVersion_HeadRotatorBone RiggedModel0;
	  public FacsVersion_FACSnimator FACSModel1;
	  public FacsVersion_HeadRotatorBone RiggedModel1;
    public FacsVersion_FACSnimator FACSModelDnn;
	  public FacsVersion_HeadRotatorBone RiggedModelDnn;
    ...
    private void HandleMessage(List<string> msg_list)
    {
        ...
        if (participants == Participants.users_1_models_1 & Array.IndexOf(topic_info, "dnn") == -1)
        {
            ...
            if (msg_count == 50)
            {
                foreach (KeyValuePair<string, JToken> pair in blend_shapes) {
